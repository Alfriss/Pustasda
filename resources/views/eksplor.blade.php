...
<body class="bg-white flex h-screen overflow-hidden antialiased text-gray-800" x-data="{ sidebarOpen: false }">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden relative bg-[#F8FAFC] w-full">
        ...
        <header class="h-[72px] flex items-center justify-between px-4 md:px-8 border-b border-gray-200 shrink-0 bg-white">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                <div class="hidden sm:block w-32 md:w-40 h-8 bg-gray-200 rounded-sm"></div>
        ...
        <div class="flex-1 overflow-y-auto px-4 sm:px-6 md:px-10 py-6 md:py-8">
            <div class="w-full">
                ...
                <div class="mb-6 md:mb-8">
                    <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight mb-2">Temukan Kompetisimu.</h1>
                ...
                <div class="flex flex-col md:flex-row gap-4 mb-6 md:mb-8">
                    ...
                    <div class="flex gap-4">
                        <select class="flex-1 md:flex-none border border-gray-200 text-gray-600 text-sm rounded-lg block p-3 bg-white focus:outline-none focus:border-[#E11D48] cursor-pointer shadow-sm min-w-[140px]">
