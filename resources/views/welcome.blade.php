    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden relative w-full">
        ...
        <div class="flex-1 overflow-y-auto px-4 sm:px-6 md:px-10 py-6 md:py-8">
            ...
            <div class="w-full">
                ...
                <!-- Hero Section -->
                <div class="relative w-full mb-6 md:mb-8 bg-white md:bg-transparent rounded-2xl md:rounded-none border md:border-none border-gray-200 p-6 md:p-0 shadow-sm md:shadow-none overflow-hidden">
                    <div class="w-full md:w-2/3 md:pr-8 relative z-10 text-center md:text-left">
                        <p class="text-[13px] md:text-sm text-gray-500 md:text-gray-400 font-medium mb-3 md:mb-3">Pusat Prestasi SMK Telkom Sidoarjo</p>
                        <h1 class="text-3xl sm:text-4xl md:text-[44px] font-extrabold text-gray-900 leading-[1.2] md:leading-[1.1] mb-4 md:mb-5 tracking-tight">
                            Track Your <br class="hidden md:block">
                            <span class="text-[#E11D48]">Competitions.</span><br>
                            Build Your <br class="hidden md:block">
                            <span class="text-[#E11D48]">Achievements.</span>
                        </h1>
                        <p class="text-[13px] sm:text-sm text-gray-600 mb-6 leading-relaxed max-w-sm mx-auto md:mx-0">
                            Platform untuk mengelola lomba, prestasi, dan perkembangan siswa dalam satu sistem yang terintegrasi.
                        </p>
                        <button class="bg-[#E11D48] text-white px-6 py-3 rounded-lg font-semibold text-sm hover:bg-rose-700 transition shadow-sm w-full md:w-auto">
                            Eksplor Lomba &rarr;
                        </button>
                    </div>

                    <!-- 3D Shape bg for desktop -->
                    <div class="hidden md:flex absolute right-0 top-0 w-[300px] h-[300px] bg-gradient-to-br from-[#E11D48] to-rose-600 rounded-tl-[150px] rounded-bl-[150px] items-center justify-center -z-0 shadow-inner">
                        <div class="text-white/80 text-sm font-semibold tracking-wider uppercase border-2 border-white/30 px-4 py-2 rounded-full">Aset Piala 3D</div>
                    </div>
                </div>

                <!-- Banners -->
                <div class="relative flex flex-col md:flex-row gap-4 mb-6 md:mb-4">
                    
                    <div class="w-full md:w-1/2 bg-gradient-to-br from-[#FFD13B] to-[#FFC000] rounded-[14px] p-6 text-white relative overflow-hidden flex flex-col justify-between min-h-[160px] md:h-[180px] shadow-sm">
                        <h2 class="text-2xl font-bold leading-tight z-10 md:w-1/2">Lomba<br>Tingkat<br>Nasional</h2>
                        <button class="bg-white text-yellow-600 hover:bg-yellow-50 text-[13px] font-bold px-4 py-2 rounded-md w-max z-10 mt-4 md:mt-2 transition shadow-sm">
                            Jelajahi &rarr;
                        </button>
                        <div class="absolute right-[-20px] bottom-[-20px] w-32 h-32 bg-yellow-300/30 rounded-full flex items-center justify-center">
                            <span class="text-xs font-semibold">Aset</span>
                        </div>
                    </div>

                    <div class="w-full md:w-1/2 flex flex-col gap-4">
                        <div class="flex-1 bg-gradient-to-r from-[#14B8A6] to-[#06B6D4] rounded-[14px] p-5 text-white flex items-center justify-between relative overflow-hidden shadow-sm hover:shadow-md transition group cursor-pointer">
                        ...
                        <div class="flex-1 bg-gradient-to-r from-[#4ADE80] to-[#22C55E] rounded-[14px] p-5 text-white flex items-center justify-between relative overflow-hidden shadow-sm hover:shadow-md transition group cursor-pointer">
                    ...
                    <div class="hidden lg:flex absolute -right-6 -top-4 w-14 h-14 bg-[#DC2626] border-[3px] border-white rounded-full shadow-md items-center justify-center z-20 cursor-pointer hover:bg-red-700 transition">
                ...
                <div class="w-full bg-gradient-to-r from-[#F43F5E] to-[#EF4444] rounded-[14px] p-5 md:p-6 mb-6 md:mb-4 flex justify-between items-center text-white relative overflow-hidden shadow-sm hover:shadow-md transition cursor-pointer">
                    <div>
                        <h3 class="text-lg md:text-xl font-bold mb-1">Sedang Ramai Diikuti</h3>
                        <p class="text-[13px] md:text-sm text-white/80 hidden sm:block">Lihat perlombaan yang paling banyak didaftar minggu ini.</p>
                    </div>
                ...
                <!-- Prestasi -->
                <div class="w-full border border-gray-200 bg-white rounded-[14px] p-5 md:p-6 mb-6 md:mb-4 shadow-sm">
                    <div class="flex items-center justify-between mb-5">
                        <h3 class="text-[16px] font-bold text-gray-900">Prestasi Terbaru</h3>
                        <button class="text-sm font-semibold text-[#E11D48] hover:text-rose-700">Lihat Semua</button>
                    </div>
                    <div class="space-y-3">
                        <div class="flex items-center gap-4 border border-gray-100 p-3 rounded-xl shadow-sm hover:bg-gray-50 transition cursor-pointer">
                            <div class="w-10 h-10 bg-amber-100 text-amber-600 flex items-center justify-center rounded-lg shrink-0 font-bold">1st</div>
                            <div>
                                <p class="text-sm font-bold text-gray-900">Juara 1 Web Design Nasional</p>
                                <p class="text-xs text-gray-500">Brahma Alfaris - Univ. Brawijaya</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 border border-gray-100 p-3 rounded-xl shadow-sm hover:bg-gray-50 transition cursor-pointer">
                            <div class="w-10 h-10 bg-gray-100 text-gray-600 flex items-center justify-center rounded-lg shrink-0 font-bold">2nd</div>
                            <div>
                                <p class="text-sm font-bold text-gray-900">Runner Up LKS IT Software</p>
                                <p class="text-xs text-gray-500">Tim SMK Telkom Sidoarjo</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Leaderboard Card -->
                <div class="w-full border border-gray-200 bg-white rounded-[14px] p-5 md:p-6 flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4 shadow-sm">
                    <div class="flex gap-4 items-center">
                        <div class="w-12 h-12 md:w-14 md:h-14 bg-[#6366F1] rounded-t-xl rounded-bl-xl relative shrink-0 shadow-inner">
                             <div class="absolute bottom-0 w-full h-1/2 bg-[#4F46E5] rounded-bl-xl"></div>
                        </div>
                        <div>
                            <h3 class="text-[15px] md:text-[17px] font-bold text-gray-900 leading-tight mb-1">Leaderboard Siswa Berprestasi</h3>
                            <p class="text-[12px] md:text-[13px] text-gray-500">Dihitung berdasarkan poin prestasi kumulatif</p>
                        </div>
                    </div>

                    <div class="relative w-full md:w-auto md:min-w-[220px]">
                        <select class="block w-full bg-gray-50 border border-gray-200 text-gray-700 py-2.5 px-4 pr-8 rounded-lg leading-tight focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:bg-white focus:border-[#6366F1] text-[13px] font-semibold appearance-none cursor-pointer transition">
